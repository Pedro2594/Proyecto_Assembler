...
symbol_table = {
    ...
    "SCREEN": 16384,
    "KBD": 24576,
    "ITSR0": 17  # Agregar ITSR0 a la tabla de símbolos con la dirección adecuada
}
...
jump_dict = {
    ...
    "JLE": "110",
    "JMP": "111",
    "ITSR0": "000"  # Agregar la etiqueta ITSR0 al diccionario de saltos
}

next_available_address = [16]  # Inicializar la variable next_available_address


def parse_A_instruction(instruction):
    global next_available_address
    if instruction.isdigit():
        # Ahora se usa un ancho de 16 bits
...
def first_pass(lines):
    global next_available_address
    next_available_address = 16  # Inicializa next_available_address en 16
    address = 0
    for line in lines:
        line = line.strip()
...
def assemble(asm_file, hack_file):
    ...
    for line in lines:
        ...
        if binary_line is not None:
            ...
            print(binary_line)  # Imprime en la terminal
